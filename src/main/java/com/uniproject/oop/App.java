...
// icon res: https://www.pngegg.com/en/png-zfnah/download?height=64
...
public class App extends Application {
    ...
    public static final int totalBombs = (tilesPerCol * tilesPerCol) / 8; // Can be made dependent on tiles per Row &
                                                                          // Col
